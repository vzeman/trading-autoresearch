...
_Last updated: 2026-04-30 06:31 UTC_  
_Total experiments: **5**  ·  kept: **2**  ·  latest commit: `9dd7191`_
...
| metric | value |
|---|---|
| Sharpe (median over seeds) | **-2.527** |
| Sharpe — bootstrap CI low (5%) | **-11.700** |
| Sharpe — bootstrap CI high (95%) | +9.596 |
| Max drawdown | -0.26% |
| Net PnL | $-49.90 (-0.100%) |
| Trades | 29 |
