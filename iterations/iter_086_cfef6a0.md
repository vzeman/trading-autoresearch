...
_2026-05-03 12:39 UTC · 579s wall_
...
**Decision reason:** ci_low=-1.9550 ≤ prior best -1.0118

## Per-seed details

```
[evaluator] seed 0: sharpe=+2.034  dd=-14.58%  pnl=$+9,245.53  trades=4
[evaluator] seed 1: sharpe=+0.412  dd=-7.44%  pnl=$+815.46  trades=4
[evaluator] seed 2: sharpe=-0.359  dd=-5.55%  pnl=$-730.16  trades=1
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_cfef6a0.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_cfef6a0.png)
...
![strategy comparison](../docs/profile_compare_cfef6a0.png)
...
**Median holdout sharpe: +0.327** (vs in-symbol +0.412)
...
```diff
cfef6a0 exp86: single 4h horizon (was 1d alone in exp85, 4h+1d in exp71)
