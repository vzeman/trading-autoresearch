...
**🔴 DISCARD** · exp193: full-budget score allocation cached

_2026-05-05 22:06 UTC · 818s wall_
...
|---|---|
| Sharpe (median) | **+0.617** |
| Sharpe CI low (5%) | -1.228 |
| Sharpe CI high (95%) | +2.695 |
| % time above SPY | 0.310% |
| Net PnL | **$+2485.78** (+4.972%) |
| Max drawdown | -20.17% |
| Trades | 3 |
| Fees | $3.00 |
| Seeds completed | 3 |
...
```
[evaluator] seed 0: sharpe=+0.145  dd=-13.57%  pnl=$+312.13  trades=3
[evaluator] seed 1: sharpe=+0.863  dd=-7.72%  pnl=$+2,485.78  trades=2
[evaluator] seed 2: sharpe=+0.617  dd=-20.17%  pnl=$+3,853.16  trades=4
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_dbb6c2d.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_dbb6c2d.png)
...
![strategy comparison](../docs/profile_compare_dbb6c2d.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_dbb6c2d.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_dbb6c2d.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_dbb6c2d.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_dbb6c2d.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_dbb6c2d.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.617)
...
```diff
dbb6c2d exp193: full-budget score allocation canonical
