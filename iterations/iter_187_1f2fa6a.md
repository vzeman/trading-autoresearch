...
**🔴 DISCARD** · exp187: calendar session features fresh train

_2026-05-05 16:19 UTC · 8772s wall_
...
|---|---|
| Sharpe (median) | **+1.420** |
| Sharpe CI low (5%) | -0.676 |
| Sharpe CI high (95%) | +3.233 |
| % time above SPY | 50.473% |
| Net PnL | **$+889.40** (+1.779%) |
| Max drawdown | -1.89% |
| Trades | 3 |
| Fees | $3.00 |
| Seeds completed | 3 |

**Decision reason:** objective=-0.5068 ≤ prior best +0.0000 (ci_low=-0.6760, over_spy=50.5%, pnl=+1.78%)
...
```
[evaluator] seed 0: sharpe=+1.420  dd=-1.31%  pnl=$+889.40  trades=3
[evaluator] seed 1: sharpe=+1.829  dd=-1.45%  pnl=$+1,101.37  trades=3
[evaluator] seed 2: sharpe=+0.373  dd=-1.89%  pnl=$+239.05  trades=3
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_1f2fa6a.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_1f2fa6a.png)
...
![strategy comparison](../docs/profile_compare_1f2fa6a.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_1f2fa6a.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_1f2fa6a.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_1f2fa6a.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_1f2fa6a.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_1f2fa6a.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +1.420)
...
```diff
1f2fa6a exp187: add calendar session seasonality features
