...
_2026-05-05 21:42 UTC · 789s wall_
...
**Decision reason:** objective=-1.2220 ≤ prior best +0.0000 (ci_low=-1.2990, over_spy=22.8%, pnl=+0.87%)
...
```
[evaluator] seed 0: sharpe=-0.211  dd=-2.52%  pnl=$-146.57  trades=3
[evaluator] seed 1: sharpe=+1.071  dd=-1.11%  pnl=$+435.04  trades=3
[evaluator] seed 2: sharpe=+0.928  dd=-2.80%  pnl=$+941.03  trades=3
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_1680fdc.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_1680fdc.png)
...
![strategy comparison](../docs/profile_compare_1680fdc.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_1680fdc.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_1680fdc.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_1680fdc.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_1680fdc.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_1680fdc.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.928)
...
```diff
1680fdc profiles: add SPY-only timing strategies
