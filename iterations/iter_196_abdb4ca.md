...
_2026-05-05 23:35 UTC · 737s wall_
...
**Decision reason:** trades=0 sharpe=+0.000 — strategy didn't trade
...
Canonical strategy for this iteration: **top4 cross-sectional picker** — rank symbols by the transformer's 4h + 1d forecast Sharpe, buy the top four once enough symbols are ready, hold through the eval window, and keep 0 median trades after costs.
...
```
[evaluator] seed 0: sharpe=+0.000  dd=+0.00%  pnl=$+0.00  trades=0
...
![weighted equity](../docs/weighted_abdb4ca.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_abdb4ca.png)
...
![strategy comparison](../docs/profile_compare_abdb4ca.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_abdb4ca.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_abdb4ca.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_abdb4ca.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_abdb4ca.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_abdb4ca.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.000)
...
```diff
abdb4ca exp196: relax setup checker threshold
