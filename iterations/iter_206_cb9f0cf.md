...
**🔴 DISCARD** · exp206: SPY one day timing canonical cached

_2026-05-07 20:27 UTC · 1962s wall_
...
|---|---|
| Sharpe (median) | **+0.939** |
| Sharpe CI low (5%) | -1.770 |
| Sharpe CI high (95%) | +3.428 |
| % time above SPY | 0.238% |
| Net PnL | **$+3321.83** (+6.644%) |
| Max drawdown | -9.79% |
| Trades | 1 |
| Fees | $1.00 |
| Seeds completed | 3 |
...
**Decision reason:** objective=-1.7028 ≤ prior best +0.0000 (ci_low=-1.7700, over_spy=0.2%, pnl=+6.64%)
...
```
[evaluator] seed 0: sharpe=+0.939  dd=-9.79%  pnl=$+3,321.83  trades=1
[evaluator] seed 1: sharpe=+0.939  dd=-9.79%  pnl=$+3,321.83  trades=1
[evaluator] seed 2: sharpe=+0.000  dd=+0.00%  pnl=$+0.00  trades=0
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_cb9f0cf.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_cb9f0cf.png)
...
![strategy comparison](../docs/profile_compare_cb9f0cf.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_cb9f0cf.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_cb9f0cf.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_cb9f0cf.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_cb9f0cf.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_cb9f0cf.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.939)
...
```diff
cb9f0cf exp206: test SPY one day timing canonical
