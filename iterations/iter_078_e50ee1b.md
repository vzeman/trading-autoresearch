...
_2026-05-03 03:31 UTC · 595s wall_
...
[evaluator] seed 3: sharpe=+1.341  dd=-13.75%  pnl=$+4,454.14  trades=3
[evaluator] seed 4: sharpe=+2.434  dd=-12.47%  pnl=$+12,017.87  trades=4
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_e50ee1b.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_e50ee1b.png)
...
```diff
e50ee1b exp78: REVERT canonical top3 → top5 (exp77 too concentrated, hit DD floor)

exp77 (top3 canonical) DISCARDED at DD -16.99% > -15 floor on seed 3.
Per-seed sharpe: {+3.13, +3.13, 0, -2.79, +1.30} — half-amazing,
half-disaster. The +2.288 'best active strategy' figure from exp76's
profile suite was an aggregate, not a real per-seed median.

top5 with full deployment (exp76 result): median +1.538, max DD -13.75% —
under the floor. Reverting to that as the stable canonical.

Same N_SEEDS=5, cached pretrain. Should reproduce exp76's median +1.538.
