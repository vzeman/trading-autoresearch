...
_2026-05-07 07:21 UTC · 736s wall_
...
**Decision reason:** objective=-0.9564 ≤ prior best +0.0000 (ci_low=-1.1360, over_spy=51.8%, pnl=+2.43%)
...
```
[evaluator] seed 0: sharpe=+0.727  dd=-5.81%  pnl=$+1,215.24  trades=10
[evaluator] seed 1: sharpe=+0.545  dd=-4.63%  pnl=$+860.42  trades=10
[evaluator] seed 2: sharpe=+2.575  dd=-5.43%  pnl=$+7,466.22  trades=9
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_d181342.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_d181342.png)
...
![strategy comparison](../docs/profile_compare_d181342.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_d181342.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_d181342.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_d181342.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_d181342.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_d181342.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.727)
...
```diff
d181342 exp205: test half exposure top10 allocation
