...
_2026-05-04 05:48 UTC · 415s wall_
...
**Decision reason:** objective=-0.3700 ≤ prior best -0.3696 (ci_low=-0.3980, over_spy=28.0%)
...
![weighted equity](../docs/weighted_c90ac3b.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_c90ac3b.png)
...
![strategy comparison](../docs/profile_compare_c90ac3b.png)
...
```diff
c90ac3b exp113: rank top4 by alpha vs SPY
