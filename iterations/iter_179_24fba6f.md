...
**🔴 DISCARD** · exp179: 180d top1 concentration

_2026-05-05 06:54 UTC · 699s wall_
...
|---|---|
| Sharpe (median) | **+0.370** |
| Sharpe CI low (5%) | -1.307 |
| Sharpe CI high (95%) | +2.309 |
| % time above SPY | 42.840% |
| Net PnL | **$+492.66** (+0.985%) |
| Max drawdown | -6.09% |
| Trades | 1 |
| Fees | $1.00 |
| Seeds completed | 3 |

**Decision reason:** objective=-1.1686 ≤ prior best +0.0000 (ci_low=-1.3070, over_spy=42.8%, pnl=+0.98%)
...
```
[evaluator] seed 0: sharpe=+1.208  dd=-5.62%  pnl=$+3,724.84  trades=1
[evaluator] seed 1: sharpe=-0.156  dd=-6.09%  pnl=$-368.74  trades=1
[evaluator] seed 2: sharpe=+0.370  dd=-1.74%  pnl=$+492.66  trades=1
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_24fba6f.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_24fba6f.png)
...
![strategy comparison](../docs/profile_compare_24fba6f.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_24fba6f.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_24fba6f.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_24fba6f.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_24fba6f.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_24fba6f.png)
...
**Median holdout sharpe: +1.649** (vs in-symbol +0.370)
...
```diff
24fba6f exp179: 180d top1 concentration
