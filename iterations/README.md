...
| 🟢 | [iter 002 — 6e143de · exp47](iter_002_6e143de.md) | SWAP pass + cap 0.65 → 0.50 — bring DD floor under -10% on all seeds | **+1.535** | **$+3,260.33** (+6.521%) |
| 🟢 | [iter 001 — 8988cee · exp42](iter_001_8988cee.md) | cap 0.95 → 0.80 — bring DD safely under floor | **+0.988** | **$+2,557.00** (+5.114%) |
