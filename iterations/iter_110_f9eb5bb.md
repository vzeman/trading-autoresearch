...
_2026-05-04 02:07 UTC · 369s wall_
...
![weighted equity](../docs/weighted_f9eb5bb.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_f9eb5bb.png)
...
![strategy comparison](../docs/profile_compare_f9eb5bb.png)
...
| **top10_picker** | +1.244 | $+2,672.07 | +5.34% | 9 | -7.64% | - |
| **top1_picker** | +0.000 | $+0.00 | +0.00% | 0 | +0.00% | - |
| **top20_picker** | +1.377 | $+1,634.19 | +3.27% | 17 | -3.29% | - |
...
```diff
f9eb5bb exp110: sector capped top4 picker
