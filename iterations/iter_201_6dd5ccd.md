...
**🔴 DISCARD** · exp201: derisked score weighted top5 cached

_2026-05-07 05:11 UTC · 751s wall_
...
|---|---|
| Sharpe (median) | **+0.219** |
| Sharpe CI low (5%) | -1.617 |
| Sharpe CI high (95%) | +2.170 |
| % time above SPY | 1.225% |
| Net PnL | **$+726.03** (+1.452%) |
| Max drawdown | -17.01% |
| Trades | 3 |
| Fees | $3.00 |
| Seeds completed | 3 |
...
```
[evaluator] seed 0: sharpe=+0.167  dd=-8.82%  pnl=$+309.68  trades=3
[evaluator] seed 1: sharpe=+0.514  dd=-9.84%  pnl=$+1,335.11  trades=3
[evaluator] seed 2: sharpe=+0.219  dd=-17.01%  pnl=$+726.03  trades=5
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_6dd5ccd.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_6dd5ccd.png)
...
![strategy comparison](../docs/profile_compare_6dd5ccd.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_6dd5ccd.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_6dd5ccd.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_6dd5ccd.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_6dd5ccd.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_6dd5ccd.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.219)
...
```diff
6dd5ccd exp201: test derisked score weighted top5
