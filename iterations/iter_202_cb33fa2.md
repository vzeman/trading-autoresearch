...
**🔴 DISCARD** · exp202: alpha over SPY score top10 cached

_2026-05-07 05:24 UTC · 725s wall_
...
| Sharpe CI high (95%) | +2.628 |
| % time above SPY | 69.374% |
| Net PnL | **$+1838.18** (+3.676%) |
| Max drawdown | -9.11% |
| Trades | 10 |
| Fees | $10.00 |
| Seeds completed | 3 |
...
**Decision reason:** objective=-0.9261 ≤ prior best +0.0000 (ci_low=-1.1710, over_spy=69.4%, pnl=+3.68%)
...
```
[evaluator] seed 0: sharpe=+0.702  dd=-9.11%  pnl=$+1,838.18  trades=10
[evaluator] seed 1: sharpe=+0.525  dd=-7.32%  pnl=$+1,288.40  trades=10
[evaluator] seed 2: sharpe=+2.531  dd=-8.42%  pnl=$+11,827.99  trades=9
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_cb33fa2.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_cb33fa2.png)
...
![strategy comparison](../docs/profile_compare_cb33fa2.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_cb33fa2.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_cb33fa2.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_cb33fa2.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_cb33fa2.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_cb33fa2.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.702)
...
```diff
cb33fa2 exp202: rank score allocator by alpha over SPY
