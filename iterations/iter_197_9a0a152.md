...
_2026-05-06 07:33 UTC · 733s wall_
...
**Decision reason:** trades=3 sharpe=+0.000 — strategy didn't trade
...
[evaluator] seed 1: sharpe=+1.543  dd=-2.15%  pnl=$+1,343.64  trades=3
[evaluator] seed 2: sharpe=-1.904  dd=-4.34%  pnl=$-1,670.32  trades=3
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_9a0a152.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_9a0a152.png)
...
![strategy comparison](../docs/profile_compare_9a0a152.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_9a0a152.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_9a0a152.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_9a0a152.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_9a0a152.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_9a0a152.png)
...
```diff
9a0a152 exp197: scan daily for setup checker entries
