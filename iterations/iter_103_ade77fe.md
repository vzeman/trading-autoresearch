...
_2026-05-04 01:16 UTC · 370s wall_
...
```
[evaluator] seed 0: sharpe=+1.550  dd=-8.73%  pnl=$+4,730.76  trades=3
[evaluator] seed 1: sharpe=+2.114  dd=-7.74%  pnl=$+6,072.58  trades=2
[evaluator] seed 2: sharpe=-1.372  dd=-4.58%  pnl=$-1,260.27  trades=1
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_ade77fe.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_ade77fe.png)
...
![strategy comparison](../docs/profile_compare_ade77fe.png)
...
|---|---:|---:|---:|---:|---:|---:|
| **daily_capped** | -2.005 | $-57.83 | -0.12% | 2 | -0.12% | 1d |
| **intraday** | -12.965 | $-24,029.29 | -48.06% | 5210 | -48.06% | 2h |
| **intramonth** | -0.916 | $-98.08 | -0.20% | 2 | -0.23% | 30d |
| **intraweek** | -4.723 | $-8,417.77 | -16.84% | 981 | -17.55% | 5d |
| **longterm** | +0.000 | $+0.00 | +0.00% | 2 | -0.23% | 30d |
| **monthly_capped** | +0.000 | $+0.00 | +0.00% | 0 | +0.00% | 30d |
| **spy_buyhold** | +0.999 | $+1,430.87 | +2.86% | 1 | -6.92% | - |
| **top10_picker** | +1.244 | $+3,337.96 | +6.68% | 9 | -8.24% | - |
| **top1_picker** | +0.000 | $+0.00 | +0.00% | 0 | +0.00% | - |
| **top20_picker** | +1.074 | $+1,933.94 | +3.87% | 18 | -9.09% | - |
| **top3_picker** | +2.088 | $+8,037.31 | +16.07% | 2 | -10.37% | - |
| **top4_picker** | +1.008 | $+2,031.36 | +4.06% | 3 | -6.63% | - |
| **top5_picker** | +1.455 | $+3,829.80 | +7.66% | 4 | -6.94% | - |
| **weekly_capped** | -1.632 | $-2,471.65 | -4.94% | 88 | -6.06% | 5d |
...
|---:|---:|---:|---:|---:|
| 0 | +0.213 | $+224.04 | 5 | -6.64% |
| 1 | -0.140 | $-274.70 | 11 | -6.16% |
| 2 | +0.213 | $+224.04 | 5 | -6.64% |
| 3 | +0.327 | $+504.54 | 5 | -9.19% |
| 4 | +0.000 | $+0.00 | 0 | +0.00% |

**Median holdout sharpe: +0.213** (vs in-symbol +1.550)

## Per-symbol summary (aggregated across all seeds)

| symbol | total trades | buys | sells | avg hold (days) | held-to-end |
|---|---:|---:|---:|---:|---:|
| **NIO** | 1627 | 815 | 812 | 0.1 | 3 |
| **COIN** | 1409 | 706 | 703 | 0.0 | 3 |
| **PLTR** | 775 | 389 | 386 | 0.1 | 3 |
| **AMD** | 661 | 332 | 329 | 0.1 | 3 |
| **INTC** | 575 | 289 | 286 | 0.1 | 3 |
| **F** | 555 | 279 | 276 | 0.3 | 3 |
| **SPY** | 551 | 277 | 274 | 0.1 | 3 |
| **ABBV** | 479 | 241 | 238 | 0.4 | 3 |
| **EEM** | 439 | 221 | 218 | 0.4 | 3 |
| **COST** | 377 | 190 | 187 | 0.1 | 3 |
| **ACN** | 375 | 189 | 186 | 0.4 | 3 |
| **HON** | 371 | 187 | 184 | 0.1 | 3 |
| **LLY** | 363 | 183 | 180 | 0.5 | 3 |
| **ELV** | 343 | 173 | 170 | 0.0 | 3 |
| **QQQ** | 327 | 165 | 162 | 0.2 | 3 |
| **GOOGL** | 327 | 165 | 162 | 0.2 | 3 |
| **PM** | 319 | 161 | 158 | 0.5 | 3 |
| **AMAT** | 301 | 152 | 149 | 0.1 | 3 |
| **NVDA** | 297 | 150 | 147 | 0.2 | 3 |
| **AVGO** | 289 | 146 | 143 | 0.2 | 3 |
| **SPGI** | 287 | 145 | 142 | 0.1 | 3 |
| **ORCL** | 265 | 134 | 131 | 0.2 | 3 |
| **AMZN** | 251 | 127 | 124 | 0.2 | 3 |
| **NFLX** | 249 | 126 | 123 | 0.7 | 3 |
| **AMT** | 237 | 120 | 117 | 0.7 | 3 |
| **DHR** | 229 | 116 | 113 | 0.2 | 3 |
| **MSFT** | 227 | 115 | 112 | 0.8 | 3 |
| **IWM** | 225 | 114 | 111 | 0.8 | 3 |
| **ABT** | 201 | 102 | 99 | 0.2 | 3 |
| **XLF** | 197 | 100 | 97 | 0.3 | 3 |
| **PFE** | 187 | 95 | 92 | 0.9 | 3 |
| **PEP** | 179 | 91 | 88 | 1.0 | 3 |
| **TXN** | 179 | 91 | 88 | 0.9 | 3 |
| **NOW** | 179 | 91 | 88 | 0.9 | 3 |
| **TSLA** | 171 | 87 | 84 | 0.3 | 3 |
| **TMO** | 171 | 87 | 84 | 1.0 | 3 |
| **BA** | 167 | 85 | 82 | 0.3 | 3 |
| **LMT** | 161 | 82 | 79 | 0.2 | 3 |
| **BAC** | 157 | 80 | 77 | 1.1 | 3 |
| **REGN** | 145 | 74 | 71 | 0.0 | 3 |
...
| **CRM** | 107 | 55 | 52 | 0.4 | 3 |
| **RTX** | 107 | 55 | 52 | 1.5 | 3 |
| **INTU** | 107 | 55 | 52 | 1.5 | 3 |
| **META** | 101 | 52 | 49 | 1.8 | 3 |
| **BKNG** | 101 | 52 | 49 | 1.4 | 3 |
| **AAPL** | 97 | 50 | 47 | 0.6 | 3 |
| **LIN** | 95 | 49 | 46 | 1.7 | 3 |
| **CAT** | 89 | 46 | 43 | 1.7 | 3 |
| **BLK** | 87 | 45 | 42 | 1.8 | 3 |
...
### Seed 0 — 14257 trades · ending equity $31,474.75 (-18,525.25 = -37.05%)
...
| … | _14057 more truncated_ | | |

### Seed 1 — 1279 trades · ending equity $46,958.66 (-3,041.34 = -6.08%)
...
### Seed 2 — 1907 trades · ending equity $46,335.93 (-3,664.07 = -7.33%)
...
```diff
ade77fe exp103: top4 with 29.0625pct cash reserve
