...
_2026-05-04 01:37 UTC · 370s wall_
...
![weighted equity](../docs/weighted_7dbaa24.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_7dbaa24.png)
...
![strategy comparison](../docs/profile_compare_7dbaa24.png)
...
| **top10_picker** | +0.138 | $+154.66 | +0.31% | 8 | -3.88% | - |
| **top1_picker** | +0.000 | $+0.00 | +0.00% | 0 | +0.00% | - |
| **top20_picker** | +0.416 | $+517.99 | +1.04% | 17 | -3.76% | - |
| **top3_picker** | +0.800 | $+1,750.73 | +3.50% | 2 | -9.61% | - |
| **top4_picker** | +0.000 | $+0.00 | +0.00% | 0 | +0.00% | - |
| **top5_picker** | +1.328 | $+2,407.11 | +4.81% | 4 | -3.40% | - |
| **weekly_capped** | -1.634 | $-2,486.75 | -4.97% | 88 | -6.16% | 5d |

**Best active strategy: `top5_picker` (sharpe +1.328) — BEATS SPY ✓**
...
**Median holdout sharpe: +0.212** (vs in-symbol +0.000)
...
| **COIN** | 1437 | 720 | 717 | 0.0 | 3 |
| **PLTR** | 811 | 407 | 404 | 0.1 | 3 |
| **AMD** | 627 | 315 | 312 | 0.1 | 3 |
| **INTC** | 587 | 295 | 292 | 0.1 | 3 |
| **F** | 561 | 282 | 279 | 0.3 | 3 |
| **SPY** | 511 | 257 | 254 | 0.1 | 3 |
| **ABBV** | 479 | 241 | 238 | 0.4 | 3 |
| **EEM** | 449 | 226 | 223 | 0.4 | 3 |
| **ACN** | 393 | 198 | 195 | 0.4 | 3 |
| **COST** | 387 | 195 | 192 | 0.1 | 3 |
| **HON** | 375 | 189 | 186 | 0.1 | 3 |
| **LLY** | 373 | 188 | 185 | 0.5 | 3 |
| **ELV** | 365 | 184 | 181 | 0.1 | 3 |
| **QQQ** | 327 | 165 | 162 | 0.2 | 3 |
| **GOOGL** | 325 | 164 | 161 | 0.2 | 3 |
| **NVDA** | 323 | 163 | 160 | 0.2 | 3 |
| **SPGI** | 321 | 162 | 159 | 0.1 | 3 |
| **PM** | 305 | 154 | 151 | 0.5 | 3 |
| **AMAT** | 301 | 152 | 149 | 0.1 | 3 |
| **NFLX** | 277 | 140 | 137 | 0.6 | 3 |
| **AVGO** | 275 | 139 | 136 | 0.2 | 3 |
| **AMZN** | 269 | 136 | 133 | 0.2 | 3 |
| **AMT** | 241 | 122 | 119 | 0.7 | 3 |
| **IWM** | 235 | 119 | 116 | 0.8 | 3 |
| **DHR** | 229 | 116 | 113 | 0.2 | 3 |
| **ORCL** | 211 | 107 | 104 | 0.2 | 3 |
| **ABT** | 199 | 101 | 98 | 0.2 | 3 |
| **PFE** | 191 | 97 | 94 | 0.9 | 3 |
| **NOW** | 185 | 94 | 91 | 0.8 | 3 |
| **MSFT** | 183 | 93 | 90 | 1.0 | 3 |
| **TXN** | 177 | 90 | 87 | 0.9 | 3 |
| **BA** | 175 | 89 | 86 | 0.3 | 3 |
| **TSLA** | 173 | 88 | 85 | 0.3 | 3 |
| **PEP** | 167 | 85 | 82 | 1.0 | 3 |
| **LMT** | 167 | 85 | 82 | 0.2 | 3 |
| **AAPL** | 165 | 84 | 81 | 0.3 | 3 |
| **TMO** | 161 | 82 | 79 | 1.1 | 3 |
| **XLF** | 159 | 81 | 78 | 0.3 | 3 |
| **GS** | 147 | 75 | 72 | 0.2 | 3 |
| **BAC** | 141 | 72 | 69 | 1.3 | 3 |
...
### Seed 0 — 14375 trades · ending equity $31,392.58 (-18,607.42 = -37.21%)
...
| … | _14175 more truncated_ | | |

### Seed 1 — 1259 trades · ending equity $46,980.93 (-3,019.07 = -6.04%)
...
### Seed 2 — 1907 trades · ending equity $46,324.91 (-3,675.09 = -7.35%)
...
```diff
7dbaa24 exp106: require positive topN score
