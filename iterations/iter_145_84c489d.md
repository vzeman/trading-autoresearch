...
_2026-05-05 00:29 UTC · 372s wall_
...
**Decision reason:** objective=+0.8018 ≤ prior best +0.8959 (ci_low=+0.7570, over_spy=44.8%)
...
```
[evaluator] seed 0: sharpe=+3.148  dd=-6.51%  pnl=$+13,556.84  trades=1
[evaluator] seed 1: sharpe=+3.148  dd=-6.51%  pnl=$+13,556.84  trades=1
[evaluator] seed 2: sharpe=+0.000  dd=+0.00%  pnl=$+0.00  trades=0
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_84c489d.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_84c489d.png)
...
![strategy comparison](../docs/profile_compare_84c489d.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_84c489d.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_84c489d.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_84c489d.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_84c489d.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_84c489d.png)
...
**Median holdout sharpe: +0.358** (vs in-symbol +3.148)
...
```diff
84c489d exp145: top1 canonical concentration
