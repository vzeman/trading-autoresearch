...
_2026-05-05 17:11 UTC · 756s wall_
...
**Decision reason:** objective=-2.0081 ≤ prior best +0.0000 (ci_low=-2.0970, over_spy=29.7%, pnl=-0.00%)
...
```
[evaluator] seed 0: sharpe=-0.039  dd=-1.69%  pnl=$-34.92  trades=3
[evaluator] seed 1: sharpe=+1.428  dd=-1.87%  pnl=$+951.59  trades=3
[evaluator] seed 2: sharpe=+0.007  dd=-1.76%  pnl=$-2.25  trades=3
```

## Equity curve (full eval window, ~73 days)

![weighted equity](../docs/weighted_07ea1a6.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_07ea1a6.png)
...
![strategy comparison](../docs/profile_compare_07ea1a6.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_07ea1a6.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_07ea1a6.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_07ea1a6.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_07ea1a6.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_07ea1a6.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.007)
...
```diff
07ea1a6 exp190: calendar top4 double 4h ranking
