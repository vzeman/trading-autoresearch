...
_2026-05-07 05:40 UTC · 747s wall_
...
**Decision reason:** objective=-0.9344 ≤ prior best +0.0000 (ci_low=-1.1460, over_spy=61.0%, pnl=+2.84%)
...
```
[evaluator] seed 0: sharpe=+0.714  dd=-6.93%  pnl=$+1,421.73  trades=10
[evaluator] seed 1: sharpe=+0.535  dd=-5.53%  pnl=$+1,004.13  trades=10
[evaluator] seed 2: sharpe=+2.559  dd=-6.45%  pnl=$+8,925.67  trades=9
```

## Equity curve (full eval window, 180 calendar days)

![weighted equity](../docs/weighted_91c972f.png)

## Equity curve (first month)

![weighted 1m](../docs/weighted_1m_91c972f.png)
...
![strategy comparison](../docs/profile_compare_91c972f.png)
...
![winning strategy trailing 1 day](../docs/winning_1d_91c972f.png)

### Trailing 1 week

![winning strategy trailing 1 week](../docs/winning_1w_91c972f.png)

### Trailing 1 month

![winning strategy trailing 1 month](../docs/winning_1mo_91c972f.png)

### Trailing 3 months

![winning strategy trailing 3 months](../docs/winning_3mo_91c972f.png)

### Trailing 6 months

![winning strategy trailing 6 months](../docs/winning_6mo_91c972f.png)
...
**Median holdout sharpe: +0.000** (vs in-symbol +0.714)
...
```diff
91c972f exp203: test lower exposure top10 allocation
