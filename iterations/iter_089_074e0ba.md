...
_2026-05-03 20:19 UTC · 381s wall_
...
**Decision reason:** ci_low=-0.4380 > prior best -1.0118

## Per-seed details

```
[evaluator] seed 0: sharpe=+1.531  dd=-12.35%  pnl=$+6,606.57  trades=3
[evaluator] seed 1: sharpe=+2.085  dd=-10.97%  pnl=$+8,497.71  trades=2
...
| **top4_picker** | +0.983 | $+2,738.98 | +5.48% | 3 | -9.30% | - |
...
**Median holdout sharpe: +0.327** (vs in-symbol +1.531)
