...
MIN_CASH_RESERVE_PCT = 0.275          # exp100: midpoint reserve between exp98 keep (25%) and exp99 discard (30%)
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp100: keep canonical top4 and test 27.5% reserve near the reserve frontier.
