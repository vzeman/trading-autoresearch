...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp178: 180d validation; test top3 diversification
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp178: canonical top3 quarter-readiness with 82.65625% reserve and 4h+1d rank blend on 180d eval.
