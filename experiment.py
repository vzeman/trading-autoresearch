...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp159: tight top2 reserve probe above 82.5%
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp159: canonical top2 quarter-readiness with 82.65625% reserve under SPY-alpha objective.
