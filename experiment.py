...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp167: best top2 reserve; test half-universe readiness
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp167: canonical top2 half-readiness with 82.65625% reserve and SPY-relative 4h+1d rank signal.
