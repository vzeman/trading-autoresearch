...
MIN_CASH_RESERVE_PCT = 0.29375        # exp102: refine reserve frontier between exp101 keep and exp99 discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp102: keep canonical top4 and test 29.375% reserve near the frontier.
