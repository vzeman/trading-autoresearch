...
MIN_CASH_RESERVE_PCT = 0.290625       # exp103: refine reserve frontier between exp101 keep and exp102 discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp103: keep canonical top4 and test 29.0625% reserve near the frontier.
