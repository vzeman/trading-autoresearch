...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp166: best top2 reserve; test SPY-relative 4h+1d rank signal
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp166: canonical top2 quarter-readiness with 82.65625% reserve and SPY-relative 4h+1d rank signal.
