...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp164: best top2 reserve; test 1d-only rank signal
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp164: canonical top2 quarter-readiness with 82.65625% reserve and 1d-only rank signal.
