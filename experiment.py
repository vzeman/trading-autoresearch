...
MIN_CASH_RESERVE_PCT = 0.828125       # exp161: midpoint between 82.65625% keep and 82.96875% discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp161: canonical top2 quarter-readiness with 82.8125% reserve under SPY-alpha objective.
