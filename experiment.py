...
MIN_CASH_RESERVE_PCT = 0.2875         # exp108: keep best reserve while testing 4h+1d+5d ranking
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp108: restore top4 and add the 5d horizon to the rank score.
