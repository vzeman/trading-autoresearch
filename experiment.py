...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp184: 180d validation; test top4 canonical
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp184: canonical top4 quarter-readiness with 82.65625% reserve and stale symbols filtered on 180d eval.
