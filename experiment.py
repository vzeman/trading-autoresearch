...
MIN_CASH_RESERVE_PCT = 0.8125         # exp154: refined top2 reserve probe below 82.5%
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp154: canonical top2 quarter-readiness with 81.25% reserve under SPY-alpha objective.
