...
MIN_CASH_RESERVE_PCT = 0.6875         # exp135: upper midpoint probe between 67.5% keep and 70% discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp135: canonical top4 quarter-readiness with 68.75% cash reserve.
