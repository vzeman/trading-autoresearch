...
MIN_CASH_RESERVE_PCT = 0.325          # exp120: continue quarter-readiness reserve frontier above exp119
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp120: canonical top4 quarter-readiness with 32.5% cash reserve.
