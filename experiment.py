...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp171: best top2 reserve; double 4h rank weight
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp171: canonical top2 quarter-readiness with 82.65625% reserve and doubled 4h rank weight.
