...
MIN_CASH_RESERVE_PCT = 0.8234375      # exp158: tighter top2 reserve probe above exp156
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp158: canonical top2 quarter-readiness with 82.34375% reserve under SPY-alpha objective.
