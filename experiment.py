...
MIN_CASH_RESERVE_PCT = 0.3375         # exp121: continue quarter-readiness reserve frontier above exp120
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp121: canonical top4 quarter-readiness with 33.75% cash reserve.
