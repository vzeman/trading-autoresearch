...
MIN_CASH_RESERVE_PCT = 0.425          # exp126: continue quarter-readiness reserve frontier above exp125
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp126: canonical top4 quarter-readiness with 42.5% cash reserve.
