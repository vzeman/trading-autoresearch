...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp165: best top2 reserve; test 4h-only rank signal
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp165: canonical top2 quarter-readiness with 82.65625% reserve and 4h-only rank signal.
