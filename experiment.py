...
MIN_CASH_RESERVE_PCT = 0.2875         # exp115: keep best reserve and test quarter-universe readiness
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp115: canonical top4 can deploy once one-quarter of symbols are ready.
