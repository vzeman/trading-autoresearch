...
MIN_CASH_RESERVE_PCT = 0.697265625    # exp140: midpoint between 69.6875% keep and 69.765625% discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp140: canonical top4 quarter-readiness with 69.7265625% cash reserve.
