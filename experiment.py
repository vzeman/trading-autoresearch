...
MIN_CASH_RESERVE_PCT = 0.30           # exp99: continue cash-reserve sweep above exp98's improved 25% reserve
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp99: keep canonical top4 and test a 30% reserve for lower tail DD.
