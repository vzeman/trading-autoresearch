...
MIN_CASH_RESERVE_PCT = 0.2890625      # exp104: refine reserve frontier between exp101 keep and exp103 discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp104: keep canonical top4 and test 28.90625% reserve near the frontier.
