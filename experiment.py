...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp181: 180d validation; top2 with long-horizon rank blend
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp181: canonical top2 quarter-readiness with 82.65625% reserve and 5d+30d rank blend on 180d eval.
