...
MIN_CASH_RESERVE_PCT = 0.2875         # exp116: keep best reserve and test one-fifth-universe readiness
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp116: canonical top4 can deploy once one-fifth of symbols are ready.
