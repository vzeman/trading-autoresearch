...
MIN_CASH_RESERVE_PCT = 0.8296875      # exp160: tight top2 reserve probe above exp159
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp160: canonical top2 quarter-readiness with 82.96875% reserve under SPY-alpha objective.
