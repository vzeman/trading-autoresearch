...
MIN_CASH_RESERVE_PCT = 0.825          # exp153: SPY-alpha objective; top2 with 82.5% reserve
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp153: canonical top2 quarter-readiness with 82.5% reserve under SPY-alpha objective.
