...
MIN_CASH_RESERVE_PCT = 0.2875         # exp101: refine reserve frontier between exp100 keep and exp99 discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp101: keep canonical top4 and test 28.75% reserve near the frontier.
