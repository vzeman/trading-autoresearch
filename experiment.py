...
MIN_CASH_RESERVE_PCT = 0.3125         # exp119: continue quarter-readiness reserve frontier above exp118
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp119: canonical top4 quarter-readiness with 31.25% cash reserve.
