...
MIN_CASH_RESERVE_PCT = 0.475          # exp128: continue quarter-readiness reserve frontier above exp127
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp128: canonical top4 quarter-readiness with 47.5% cash reserve.
