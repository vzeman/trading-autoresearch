...
MIN_CASH_RESERVE_PCT = 0.3625         # exp123: continue quarter-readiness reserve frontier above exp122
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp123: canonical top4 quarter-readiness with 36.25% cash reserve.
