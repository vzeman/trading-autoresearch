...
MIN_CASH_RESERVE_PCT = 0.6970703125   # exp141: midpoint between 69.6875% keep and 69.7265625% discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp141: canonical top4 quarter-readiness with 69.70703125% cash reserve.
