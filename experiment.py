...
MIN_CASH_RESERVE_PCT = 0.69765625     # exp139: midpoint between 69.6875% keep and 69.84375% discard
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp139: canonical top4 quarter-readiness with 69.765625% cash reserve.
