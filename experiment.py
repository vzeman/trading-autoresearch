...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp188: calendar features; test lower-variance top10 canonical
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp188: canonical top10 calendar-feature strategy. exp187 profile showed
    # top10 positive across all seeds with lower dispersion than top4.
