...
MIN_CASH_RESERVE_PCT = 0.821875       # exp156: tight top2 reserve probe just below 82.5%
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp156: canonical top2 quarter-readiness with 82.1875% reserve under SPY-alpha objective.
