...
MIN_CASH_RESERVE_PCT = 0.8265625      # exp173: fresh pretrain on best top2 strategy
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp173: canonical top2 quarter-readiness with 82.65625% reserve and 4h+1d rank blend.
