...
MIN_CASH_RESERVE_PCT = 0.375          # exp124: continue quarter-readiness reserve frontier above exp123
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp124: canonical top4 quarter-readiness with 37.5% cash reserve.
