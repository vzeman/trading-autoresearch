...
MIN_CASH_RESERVE_PCT = 0.8375         # exp155: refined top2 reserve probe above 82.5%
...
def train_and_eval(seed: int = 0) -> tuple:
    ...
    # exp155: canonical top2 quarter-readiness with 83.75% reserve under SPY-alpha objective.
